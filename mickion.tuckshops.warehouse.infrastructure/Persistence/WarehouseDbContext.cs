...
namespace mickion.tuckshops.warehouse.infrastructure.Persistence
{
    ...
    public class WarehouseDbContext(DbContextOptions<WarehouseDbContext> options) : AuditableFieldsDbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) 
        {
            ...
            modelBuilder.Entity<Brand>().HasIndex(x => x.Name);
            modelBuilder.Entity<Product>().HasIndex(x => x.Name);
            modelBuilder.Entity<Measurement>().HasIndex(x => x.Size);
            modelBuilder.Entity<Measurement>().HasIndex(x => x.Type);
